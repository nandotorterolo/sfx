...
public class TestMapeoConstructorLista extends TestCase {
  ...
  /**
   * Class2(...)["a" 7 0 |"a" 1.1]   EQUIVALENTE -> [[Class2("a" 7 0) Class2("a" 1.1)]
   * Date(...)[2015 5 17|2015 5 18|2015 11 11]  EQUIVALENTE -> [Date(2015 5 17) Date(2015 5 18)]
   */
  public void testConstructor3() {

    String value = "Date(...)[2015 5 17|2015 5 18|2015 11 11]";
    logger.log(Level.INFO, value);
    SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");

    Date fecha1 = new Date(2015 - 1900, 5, 17);
    Date fecha2 = new Date(2015 - 1900, 5, 18);
    Date fecha3 = new Date(2015 - 1900, 11, 11);
  ...
  /**
   * Class2["a" 7 0 |"a" 1.1]   EQUIVALENTE -> [[Class2("a" 7 0) Class2("a" 1.1)]
   * Date[2015 5 17|2015 5 18]  EQUIVALENTE -> [Date(2015 5 17) Date(2015 5 18)]
   */
  public void testConstructor4() {

    String value = "Date[2015 5 17|2015 5 18]";
    logger.log(Level.INFO, value);
    SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
